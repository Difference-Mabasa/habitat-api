...
/** Tenant-side decline notice. CTA pushes them back to /browse. */
@Component
@Slf4j
@RequiredArgsConstructor
public class ViewingRejectedListener {
    ...
    public void onViewingRejected(ViewingRejectedEvent event) {
        ...
        tryPush(tenant,
                NotificationType.VIEWING_REJECTED,
                NotificationMessages.VIEWING_REJECTED_TITLE,
                TemplateUtils.format(
                        NotificationMessages.VIEWING_REJECTED_BODY,
                ...
                "/my-viewings",
                NotificationMessages.VIEWING_REJECTED_ACTION_LABEL,
                viewing.getId());
    }
